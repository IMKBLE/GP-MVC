...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--input_nA', type=int, default=216, help='# of input image channels')
        self.parser.add_argument('--input_nB', type=int, default=76, help='# of input image channels')
        self.parser.add_argument('--input_nCC', type=int, default=64, help='# of input image channels')
